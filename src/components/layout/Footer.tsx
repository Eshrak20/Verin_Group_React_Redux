...
//   // ১. বর্তমান রাউট অনুযায়ী কোম্পানির Key নির্ধারণ
//   const companyKey =
//     pathname.startsWith("/decor") || pathname.startsWith("/products")
//       ? "verin-decor"
//       : pathname.startsWith("/electronics") // আগে এখানে /laptops ছিল
//         ? "verin-electronics"
//         : "verin-group";

//   // ব্যাকগ্রাউন্ড কালার লজিক (সংশোধিত)
//   const footerBg =
//     pathname.startsWith("/decor") || pathname.startsWith("/products")
//       ? "bg-[#FFFFFF]"
//       : pathname.startsWith("/electronics") // আগে এখানে /laptops ছিল
...
//   // ২. ওই নির্দিষ্ট কোম্পানির পেজ ডাটা ব্যাকগ্রাউন্ডে ফেচ বা ক্যাশ করে রাখা
//   const { data: footerPagesData } = useGetFooterPagesByCompanyQuery(companyKey);
...
//             <ul className="flex flex-col gap-2.5">
//               {customerServiceLinks.map((link) => {
//                 // API ডাটা থেকে ডাইনামিক টাইটেল ম্যাচ করা (যদি থেকে থাকে)
//                 const matchedPage = footerPagesData?.data?.find(
//                   (p) => p.page_type === link.pageType
//                 );
