  ...
  return (
    <section className="min-h-screen bg-[#FAF9F6] pt-12 pb-24 px-6 md:px-12">
      ...
      <div className="mb-10">
        <Link
          to="/decor"
          className="text-sm font-bold tracking-widest text-gray-400 hover:text-gray-900 flex items-center gap-1.5 text- uppercase"
        >
          ← BACK TO CATALOG
        </Link>
      </div>
          ...
          <div className="w-full bg-white rounded-[32px] overflow-hidden shadow-sm relative border border-gray-100">
            ...
            <div className="w-full h-full rounded-[32px] overflow-hidden relative">
              <img
                ...
                alt={product.name}
                className="w-full h-auto block min-h-75 object-cover"
              />
            </div>
